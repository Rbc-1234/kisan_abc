        ...
        if (id==0):
            ...
            if requests.method=="POST":
                if userform.is_valid():
                    ...
                    aah=userform.cleaned_data['status']
                    jk=userform.cleaned_data['userstatus']
                    usertb=users(name=ac,full_name=ad,email=ae,mobile_no=aj,status=aah,userstatus=jk)
                    usertb.save()
